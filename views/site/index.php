    ...
    <div class="single-info row mt-40">
      ...
      <div class="col-lg-6 col-md-12 no-padding info-rigth">
        <div class="info-content">
          ...
          <p>
            inappropriate behavior is often laughed off as “boys will be boys,” women face higher conduct standards –
            especially in the workplace. That’s why it’s crucial that, as women. inappropriate behavior is often laughed
            off as “boys will be boys,” women face higher conduct standards – especially in the workplace. That’s why
      ...
      <div class="active-works-carousel mt-40 col-lg-8">
        <div class="item">
          ...
          <div class="caption text-center mt-20">
            ...
            <p>LCD screens are uniquely modern in style, and the liquid crystals that make them work have <br> allowed
              humanity to create slimmer, more portable technology.</p>
          </div>
        </div>
        <div class="item">
          <img class="img-fluid" src="img/why.jpg" alt="">
      ...
      <div class="faq-content col-lg-9 col-md-9">
        <div class="single-faq">
          ...
          <p>
            ...
            double standard when it comes to their behavior. While men’s borderline-inappropriate behavior.
          </p>
        </div>
        <div class="single-faq">
          <h2 class="text-uppercase">
